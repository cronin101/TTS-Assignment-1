...
class StringTokenizer:
  ...
  '''
  def __init__(self, input_string, split_and_merge = False, token_correction = False, include_3grams = False):
...
class FileTokenizer:
  ...
  def __init__(self, input_filename, split_and_merge = False, token_correction = False, include_3grams = False):
  ...
  def all(self):
    for line in self.lines:
      yield StringTokenizer(line, self.split_and_merge, self.token_correction, self.include_3grams)
